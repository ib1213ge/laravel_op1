                            ...
                            <thead class="px-0 m-auto">
                              ...
                              @endif
                                ...
                                <tr class="row border-bottom">
                                    ...
                                    <td class="col-2"><a href="{{ route('timers.show', $timer->id) }}" class="btn btn-light bg-white text-primary border-0"><i class="fa fa-play-circle fa-lg fa-hover" aria-hidden="true"></i></a></td>
                                    @if(($timer->icon_id) === 1)
                        ...
                        <form method="POST" action="{{ route('timers.unregistered') }}" enctype="multipart/form-data" class="form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 col-9 pl-0">
                                            <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" autofocus placeholder="必須ではありません">
                                            @error('title')
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <button type="submit" formaction="{{ route('timers.create') }}" class="btn btn-info w-100">My Timer に登録</button>
                                </div>
